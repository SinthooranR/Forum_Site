...
const ForumPageCard: FC<ForumPageCardProps> = ({
  ...
  return (
    <>
      <div className="bg-slate-900 shadow-md p-8">
        {/* User Name */}
        ...
        {/* Description */}
        <p className="text-white mb-4 whitespace-pre-line break-words">
          {description}
        </p>

        {/* Date Created and Number of Comments */}
        <div className="flex items-center justify-between text-sm text-white">
          <div>Created {formattedTime}</div>
        </div>
        {userId === user?.userId && (
          <div className="flex pt-2 relative w-fit">
            <svg
